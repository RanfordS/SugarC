...
#define TK_ISBRACKET(t) RANGE(TK_BRACKET_OPEN_ROUND,t,TK_BRACKET_BLOCK_TERNARY)
#define TK_ISBRACKET_OPEN(t) \
    RANGE(TK_BRACKET_OPEN_ROUND,t,TK_BRACKET_OPEN_TERNARY)
#define TK_ISBRACKET_CLOSE(t) \
    RANGE(TK_BRACKET_CLOSE_ROUND,t,TK_BRACKET_CLOSE_TERNARY)
#define TK_ISBRACKET_BLOCK(t) \
    RANGE(TK_BRACKET_BLOCK_ROUND,t,TK_BRACKET_BLOCK_TERNARY)
